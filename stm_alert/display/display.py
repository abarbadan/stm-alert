    ...
    def __init__(self, which_screen: str):
        match which_screen:
            ...
            case "right":
                ...
                self.backlight = 50
            case _:
                raise ValueError(f"Invalid screen. Please specify 'central', 'left', or 'right'.")
...
if __name__ == "__main__":
    ...
    images = [np.zeros((display.height, display.width, 3), dtype=np.uint8) for display in displays]
